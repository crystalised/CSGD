...
namespace CoinHunt
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            audioEngine = new AudioEngine(@"Content\xactAudio.xgs");
            soundBank = new SoundBank(audioEngine, @"Content\soundBank.xsb");
            waveBank = new WaveBank(audioEngine, @"Content\waveBank.xwb");
            currentSong = soundBank.GetCue("bgmCue");
            currentSong.Apply3D(listener, emitter);
            currentSong.Play();
        ...
        {
            Vector3 objectPos = new Vector3((float)Math.Cos(gameTime.TotalGameTime.Seconds) / 2, 0, (float)Math.Sin(gameTime.TotalGameTime.Seconds));
