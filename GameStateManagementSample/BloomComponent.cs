...
namespace CoinHunt
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = Game.Content.Load<Effect>("BloomEffect/BloomExtract");
            bloomCombineEffect = Game.Content.Load<Effect>("BloomEffect/BloomCombine");
            gaussianBlurEffect = Game.Content.Load<Effect>("BloomEffect/GaussianBlur");
